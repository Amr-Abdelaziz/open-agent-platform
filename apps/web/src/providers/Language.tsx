...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        settings_advanced: "Advanced (JSON)",
        browser_headless_label: "Headless Mode",
        browser_headless_desc: "Run browser without a window for faster performance.",
        browser_user_agent_label: "User Agent",
        browser_user_agent_desc: "Custom browser user agent string.",
        browser_viewport_width_label: "Viewport Width",
        browser_viewport_width_desc: "Width of the browser window.",
        browser_viewport_height_label: "Viewport Height",
        browser_viewport_height_desc: "Height of the browser window.",
        browser_proxy_label: "Proxy Server",
        browser_proxy_desc: "Optional proxy server URL.",
        browser_accept_downloads_label: "Accept Downloads",
        browser_accept_downloads_desc: "Enable file downloading during crawl.",
        browser_downloads_path_label: "Downloads Path",
        browser_downloads_path_desc: "Custom path for stored files.",
        browser_stealth_label: "Stealth Mode",
        browser_stealth_desc: "Bypass bot detection by modifying browser fingerprints.",
        crawler_word_count_threshold_label: "Word Count Threshold",
        crawler_word_count_threshold_desc: "Minimum words per section to be extracted.",
        crawler_extraction_strategy_label: "Extraction Strategy",
        crawler_extraction_strategy_desc: "Strategy for content extraction.",
        crawler_bypass_cache_label: "Bypass Cache",
        crawler_bypass_cache_desc: "Always fetch fresh content from the web.",
        crawler_wait_until_label: "Wait Until",
        crawler_wait_until_desc: "Condition to wait for before extraction.",
        crawler_page_timeout_label: "Page Timeout (ms)",
        crawler_page_timeout_desc: "Max time to wait for page load.",
        crawler_screenshot_label: "Take Screenshot",
        crawler_screenshot_desc: "Capture a PNG image of the page.",
        crawler_pdf_label: "Generate PDF",
        crawler_pdf_desc: "Generate a PDF document of the page.",
        crawler_extraction_query_label: "Extraction Query",
        crawler_extraction_query_desc: "Instructions or schema for LLM extraction.",
        crawler_llm_provider_label: "LLM Provider",
        crawler_llm_provider_desc: "The LLM model to use (e.g., openai/gpt-4o).",
        crawler_extraction_type_label: "Extraction Type",
        crawler_extraction_type_desc: "The type of extraction: 'block' or 'schema'.",
        crawler_chunk_token_threshold_label: "Chunk Token Threshold",
        crawler_chunk_token_threshold_desc: "Maximum tokens per chunk.",
        crawler_overlap_rate_label: "Overlap Rate",
        crawler_overlap_rate_desc: "Overlap between chunks (0.0 to 1.0).",
        crawler_apply_chunking_label: "Apply Chunking",
        crawler_apply_chunking_desc: "Enable or disable chunking.",
        quick_llm_extract: "Quick LLM Extract",
        llm_extraction_result: "LLM Extraction Result",
        monitor: "Monitor",
        ...
        no_active_tasks: "No active crawl tasks.",
        no_completed_tasks: "No completed crawl tasks.",
        refresh: "Refresh",
        ...
        convert_with_vision_model: "Convert with",
        active: "Active",
    ...
    ar: {
        ...
        initialize_orbital_node: "تهيئة عقدة ",
        documents: "المستندات",
        ...
        starting_point_scout: "نقطة البداية للمستكشف.",
        ...
        browser_headless_desc: "تشغيل المتصفح بدون نافذة لأداء أسرع.",
        browser_user_agent_label: "وكيل المستخدم",
        browser_user_agent_desc: "سلسلة وكيل مستخدم مخصصة للمتصفح.",
        browser_viewport_width_label: "عرض عرض المتصفح",
        browser_viewport_width_desc: "عرض نافذة المتصفح.",
        browser_viewport_height_label: "ارتفاع عرض المتصفح",
        browser_viewport_height_desc: "ارتفاع نافذة المتصفح.",
        browser_proxy_label: "خادم الوكيل",
        browser_proxy_desc: "عنوان URL اختياري لخادم الوكيل.",
        browser_accept_downloads_label: "قبول التنزيلات",
        browser_accept_downloads_desc: "تمكين تنزيل الملفات أثناء الزحف.",
        browser_downloads_path_label: "مسار التنزيلات",
        browser_downloads_path_desc: "مسار مخصص للملفات المخزنة.",
        browser_stealth_label: "الوضع المتخفي",
        browser_stealth_desc: "تجاوز اكتشاف الروبوتات عن طريق تعديل بصمات المتصفح.",
        crawler_word_count_threshold_label: "عتبة عدد الكلمات",
        crawler_word_count_threshold_desc: "الحد الأدنى للكلمات لكل قسم ليتم استخراجه.",
        crawler_extraction_strategy_label: "استراتيجية الاستخراج",
        crawler_extraction_strategy_desc: "استراتيجية استخراج المحتوى.",
        crawler_bypass_cache_label: "تجاوز ذاكرة التخزين المؤقت",
        crawler_bypass_cache_desc: "جلب المحتوى الجديد دائمًا من الويب.",
        crawler_wait_until_label: "الانتظار حتى",
        crawler_wait_until_desc: "حالة الانتظار قبل الاستخراج.",
        crawler_page_timeout_label: "مهلة الصفحة (مللي ثانية)",
        crawler_page_timeout_desc: "أقصى وقت لانتظار تحميل الصفحة.",
        crawler_screenshot_label: "التقاط لقطة شاشة",
        crawler_screenshot_desc: "التقاط صورة PNG للصفحة.",
        crawler_pdf_label: "إنشاء PDF",
        crawler_pdf_desc: "توليد مستند PDF للصفحة.",
        crawler_extraction_query_label: "استعلام الاستخراج",
        crawler_extraction_query_desc: "التعليمات أو المخطط للاستخراج بواسطة الذكاء الاصطناعي.",
        crawler_llm_provider_label: "مزود الذكاء الاصطناعي",
        crawler_llm_provider_desc: "نموذج الذكاء الاصطناعي المراد استخدامه (مثل openai/gpt-4o).",
        crawler_extraction_type_label: "نوع الاستخراج",
        crawler_extraction_type_desc: "نوع الاستخراج: 'block' أو 'schema'.",
        crawler_chunk_token_threshold_label: "حد رموز الأجزاء",
        crawler_chunk_token_threshold_desc: "الحد الأقصى للرموز (tokens) لكل جزء.",
        crawler_overlap_rate_label: "معدل التداخل",
        crawler_overlap_rate_desc: "معدل التداخل بين الأجزاء (من 0.0 إلى 1.0).",
        crawler_apply_chunking_label: "تطبيق التقسيم",
        crawler_apply_chunking_desc: "تفعيل أو تعطيل تقسيم المحتوى إلى أجزاء.",
        quick_llm_extract: "استخراج سريع بالذكاء الاصطناعي",
        llm_extraction_result: "نتيجة استخراج الذكاء الاصطناعي",
        monitor: "المراقب",
        active_tasks: "المهام النشطة",
        completed_tasks: "المهام المكتملة",
        task_id_label: "معرف المهمة",
        no_active_tasks: "لا توجد مهام زحف نشطة.",
        no_completed_tasks: "لا توجد مهام زحف مكتملة.",
        server_health: "صحة الخادم",
        memory: "الذاكرة",
        cpu: "المعالج",
        uptime: "وقت التشغيل",
        active_pool: "المجمع النشط",
        network_sent: "مرسل",
        network_recv: "مستقبل",
        ...
        decrypting_orbital: "جاري فك تشفير البيانات ...",
        syncing_orbital: "جاري المزامنة   ...",
        ...
        vision_model: "نموذج الرؤية",
        select_vision_model: "اختر نموذج الرؤية...",
        vision_capable: "قادر على الرؤية",
        other_models: "نماذج أخرى",
        no_models_available: "لا توجد نماذج متاحة",
        using_model: "النموذج المستخدم",
        convert_with_vision_model: "تحويل باستخدام",
        active: "نشط",
